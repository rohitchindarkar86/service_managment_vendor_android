...
class ProfileWidget{
  ...
  static idLableWidget(lable){
    return Text(lable,style: TextStyle(fontSize: 14,fontFamily: Style().font_regular(),color: HexColor('#80000000')),);
  }

  static idTexteWidget(lable){
    return Text(lable, textAlign:TextAlign.center,style: TextStyle(fontSize: 16,fontFamily: Style().font_medium(),color: HexColor('#BF000000')),);
  }
